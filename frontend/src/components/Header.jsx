...
export function Header({ isRecording, isPaused }) {
    return (
        <header className="flex items-center justify-between p-4 md:px-8 backdrop-blur-xl bg-white/5 border-b border-white/10 shrink-0 z-10 shadow-lg shadow-black/20">
            <div className="flex items-center gap-3">
                ...
                <h1 className="text-xl md:text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-zinc-400 tracking-tight">Interview Copilot</h1>
            </div>
